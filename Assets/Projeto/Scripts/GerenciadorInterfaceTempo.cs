...
public class GerenciadorInterfaceTempo : MonoBehaviour
{
    ...
    [Header("Barras de Barulho (Pontua��o)")]
    ...
    void Update()
    {
        ...
        if (tempoAtual <= 0)
        {
            ...
            {
                // CRUCIAL: S� pune com derrota se o tempo acabar NO TURNO DO JOGADOR
                ...
                // Se o tempo acabar no turno da Madu, for�a a finaliza��o do turno dela de forma limpa
                else if (TabuleiroManager.Instancia.turnoAtual == TabuleiroManager.EstadoTurno.Inimigo)
                {
                    Debug.LogWarning("[TEMPO] Tempo esgotado para a Madu! For�ando passagem de turno.");
    ...
    public void IniciarTemporizador()
    {
        ...
        // CORRE��O VISUAL: Garante que a barra volte a ficar 100% cheia imediatamente no clique/troca de turno
        if (barraTempoPreenchimento != null)
        {
